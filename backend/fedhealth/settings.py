...
ML_FEATURES = ['fever', 'cough', 'fatigue', 'headache', 'vomiting', 'breathlessness', 'temperature_c', 'heart_rate', 'bp_systolic', 'wbc_count', 'platelet_count', 'hemoglobin']
ML_TARGET = 'disease_label'
# ============================================
