...
test_endpoints = [
    ("PHC Dashboard Metrics", "/api/phc/dashboard-metrics/"),
    ("District Dashboard Metrics", "/api/district/dashboard-metrics/"),
    ("Surveillance Dashboard Metrics", "/api/surveillance/dashboard-metrics/"),
]
...
print("   - 401/403: Endpoint exists but requires authentication")
print("   - 500: Endpoint has errors (needs fixing)")
print("   - Other: Connection or routing issue")
print("=" * 70)
